...
export default function App() {
  return (
    <div style={{ backgroundColor: 'gray', minHeight: '100%' }}>
    ...
    <Grid container spacing={3} style={{ padding: '16px' }}>
      ...
      <Grid item xs={2}>
        <Button sx={{ color: '#c88a8a' }} style={{paddingRight: '20px'}}>
          <MoreHorizIcon />
        </Button>
      </Grid>
      <Grid item>{accountInfo.length > 0 && accountInfo[0].balance}원</Grid>
  ...
  <Grid container spacing={3} style={{padding: '16px'}}>
    ...
    <Grid item xs={2}>
      <Button sx={{ color: '#7FB4D4' }} style={{paddingRight: '20px'}}>
        <SettingsIcon/>
      </Button>
    </Grid>
    <Grid item>
  ...
  <Grid container spacing={2} style={{padding: '16px'}}>
    ...
    <Grid item sx={{ display: 'flex', justifyContent: 'flex-end' }} xs={10}>
      ...
      >
        {accountInfo.length > 0 && accountInfo[0].balance%10}원
      </Button>
      <Button
        type="submit"
        variant="contained"
      ...
      >
        {accountInfo.length > 0 && accountInfo[0].balance%100}원
      </Button>
      <Button
        type="submit"
        variant="contained"
      ...
      >
        {accountInfo.length > 0 && accountInfo[0].balance%1000}원
      </Button>
    </Grid>
  </Grid>
</Card>
